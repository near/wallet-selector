...
```bash
yarn nx run @near-wallet-selector/core:build # build the core library
yarn nx run @near-wallet-selector/wallet-connect:build # build the WalletConnect library
