# @near-wallet-selector/modal-ui-redesign
...
```bash
# Using Yarn
yarn add @near-wallet-selector/modal-ui-redesign

# Using NPM.
npm install @near-wallet-selector/modal-ui-redesign
```
...
import { setupModal } from "@near-wallet-selector/modal-ui-redesign";
...
@import "~@near-wallet-selector/modal-ui-redesign/styles.css";
```
