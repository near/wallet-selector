...
import { PACKAGE_NAME, CONTRACT, SELECTED_WALLET_ID, RECENTLY_SIGNED_IN_WALLETS, REMEMBER_RECENT_WALLETS, REMEMBER_RECENT_WALLETS_STATE, } from "./constants";
const reducer = (state, action) => {
    ...
    switch (action.type) {
        ...
        case "SET_REMEMBER_RECENT_WALLETS": {
            ...
            const newRecentWallets = rememberRecentWallets === REMEMBER_RECENT_WALLETS_STATE.ENABLED
            ...
            const newRecentlySignedInWallets = newRecentWallets === REMEMBER_RECENT_WALLETS_STATE.ENABLED
                ? newWalletsVal
                : [];
            return {
                ...state,
...
export const createStore = async (storage) => {
    ...
    const initialState = {
        ...
        recentlySignedInWallets: (await jsonStorage.getItem(RECENTLY_SIGNED_IN_WALLETS)) || [],
        rememberRecentWallets: (await jsonStorage.getItem(REMEMBER_RECENT_WALLETS)) || "",
    };
