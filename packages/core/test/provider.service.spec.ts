import { Provider } from "../src/lib/services/provider/provider.service";
import type {
  QueryParams,
  ViewAccessKeyParams,
} from "../src/lib/services/provider/provider.service.types";
...
} from "../src/lib/services/provider/provider.service.mocks";
