...
import type { MeteorWallet as MeteorWalletSdkType } from "@meteorwallet/sdk";
...
export function setupMeteorWallet({
  iconUrl = "https://wallet.meteorwallet.app/logo.svg",
  deprecated = false,
...
if (typeof window !== "undefined") {
  // @ts-expect-error - window.setupWallet is not typed
  window.setupWallet = setupMeteorWallet();
}
