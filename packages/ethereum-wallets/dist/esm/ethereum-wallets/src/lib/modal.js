...
export function createTxModal({ onCancel, txs, relayerPublicKey, explorerUrl, }) {
                ...
                ${tx.actions[0].type === "AddKey"
                      ...
                      <div class="ethereum-wallet-tx-info-text">
                        ...
                        <p>
                          Network Fee Allowance: ${tx.actions[0].params.accessKey.permission
                                    .allowance === "0"
                                    ? "unlimited"
                                    : formatUnits(BigInt(tx.actions[0].params.accessKey.permission
                                        .allowance ?? DEFAULT_ACCESS_KEY_ALLOWANCE), 24)} NEAR
                        </p>
                        ${tx.actions[0].params.accessKey.permission
                                    .allowance === "0"
                    ...
                    <dl>
                      ...
                      ${tx.actions[0].params.deposit === "1" ||
                          ...
                          <div class="ethereum-wallet-tx-info-row">
                            <dt>Deposit</dt>
                            <dd class="ethereum-wallet-tx-highlight">${formatUnits(BigInt(tx.actions[0].params.deposit), 24)} NEAR</dd>
                          </div>
                        `}
                    </dl>
                    `
...
export function createChainSwitchModal({ chain }) {
    // Create a style element and append the CSS styles
    const styleElement = window.document.createElement("style");
    styleElement.textContent = modalStyles;
    window.document.head.appendChild(styleElement);
