...
import { KeyPair as NearKeyPair, Account as NearAccount } from "near-api-js";
...
export const getNear = async (): { account: NearAccount; accountId: string; keyPair: NearKeyPair; secretKey: string; } => {
