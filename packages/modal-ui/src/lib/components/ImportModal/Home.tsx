  ...
  return (
    <div className="wallet-home-wrapper">
      <div className="nws-modal-header-wrapper">
        <ModalHeader
          title={translate("modal.importAccounts.transferYourAccounts")}
      ...
      <div className="wallet-info-wrapper what-wallet-hide">
        <div className="wallet-what">
          ...
          <div className="content-side">
            <h3>{translate("modal.importAccounts.chooseAWallet")}</h3>
            <p>{translate("modal.importAccounts.selectAWallet")}</p>
          </div>
        </div>
        <div className="wallet-what">
          <svg
          ...
          <div className="content-side">
            <h3>{translate("modal.importAccounts.selectYourAccounts")}</h3>
            <p>{translate("modal.importAccounts.afterDecide")}</p>
          </div>
        </div>
        <div className="button-spacing" />
        <div className="middleContainer">
          <p>{translate("modal.importAccounts.disclaimer")}</p>
        </div>
      </div>
    </div>
  );
