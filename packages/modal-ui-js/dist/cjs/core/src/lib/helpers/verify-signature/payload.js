...
exports.serializeNep413 = exports.payloadSchema = exports.createPayload = void 0;
...
const serializeNep413 = (signMessageParams) => {
    const payload = (0, exports.createPayload)(signMessageParams);
    return Buffer.from((0, borsh_1.serialize)(exports.payloadSchema, payload));
};
