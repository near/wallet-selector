        ...
        <div class="wallet-info-wrapper  what-wallet-hide">
          ...
          <div class="wallet-what">
            <div class="icon-side">
              ...
              <circle cx="28.3333" cy="23.8333" r="1.66667" fill="#568FFC"/>
                <path d="M35 12.1667H7C5.89543 12.1667 5 11.2712 5 10.1667V7.5C5 6.39543 5.89543 5.5 7 5.5H31.6667" stroke="#568FFC" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M35 12.1667V35.5H7C5.89543 35.5 5 34.6046 5 33.5V8.83334" stroke="#568FFC" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
            <div class="content-side">
