...
export class TransactionModal extends Modal {
  ...
  private render() {
    ...
    if (hasSensitiveAction) {
      ...
      warning.textContent = '⚠️ This transaction includes sensitive operations. Please review carefully.';
  ...
  private async handleApprove() {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Transaction approval failed';
