...
This is the [Keypom](https://chrome.google.com/webstore/detail/keypom-wallet/epapihdplajcdnnkdeiahlgigofloibg) package for NEAR Wallet Selector.
...
```bash
# Using Yarn
yarn add @near-wallet-selector/keypom

# Using NPM.
npm install @near-wallet-selector/keypom
```
