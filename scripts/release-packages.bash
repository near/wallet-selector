...
npm publish dist/packages/meteor-wallet-app --tag "${TAG}" --otp "${OTP}"
...
npm publish dist/packages/unity-wallet --tag "${TAG}" --otp "${OTP}"
...
npm publish dist/packages/react-hook --tag "${TAG}" --otp "${OTP}"
npm publish dist/packages/hot-wallet --tag "${TAG}" --otp "${OTP}"
npm publish dist/packages/intear-wallet --tag "${TAG}" --otp "${OTP}"
