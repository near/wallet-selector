...
var index_js = require('near-api-js/lib/providers/index.js');
...
class Provider {
  ...
  urlsToProviders(urls) {
    return urls && urls.length > 0 ? urls.map(url => new index_js.JsonRpcProvider({
      url
    })) : [];
  }
}
...
var onUnhandled = function (state) {
  call$c(task, globalThis$d, function () {
