...
var NearWallet_1 = __importDefault(require("../wallets/browser/NearWallet"));
var SenderWallet_1 = __importDefault(require("../wallets/injected/SenderWallet"));
var LedgerWallet_1 = __importDefault(require("../wallets/hardware/LedgerWallet"));
var MetaMaskWallet_1 = __importDefault(require("../wallets/injected/MetaMaskWallet"));
var WalletController = /** @class */ (function () {
    ...
    WalletController.prototype.setupWalletModules = function () {
        ...
        return this.options.wallets
            ...
            switch (walletId) {
                case "near-wallet":
                    return (0, NearWallet_1.default)();
                case "sender-wallet":
                    return (0, SenderWallet_1.default)();
                case "ledger-wallet":
                    return (0, LedgerWallet_1.default)();
                case "metamask-wallet":
                    return (0, MetaMaskWallet_1.default)();
                default:
            ...
            return module({
                ...
                logger: logging_service_1.logger,
                storage: persistent_storage_service_1.storage,
                updateState: State_1.updateState,
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        selectedWalletId = persistent_storage_service_1.storage.getItem(constants_1.LOCAL_STORAGE_SELECTED_WALLET_ID);
                    ...
                    case 2:
                        signedIn = _a.sent();
                        if (signedIn) {
                            (0, State_1.updateState)(function (prevState) { return (__assign(__assign({}, prevState), { selectedWalletId: selectedWalletId })); });
                            return [2 /*return*/];
                        }
                        _a.label = 3;
                    case 3:
                        if (selectedWalletId) {
                            persistent_storage_service_1.storage.removeItem(constants_1.LOCAL_STORAGE_SELECTED_WALLET_ID);
                        }
                        return [2 /*return*/];
                }
            });
