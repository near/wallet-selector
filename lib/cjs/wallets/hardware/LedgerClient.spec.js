...
var createTransactionMock = function () {
    var actions = [
        near_api_js_1.transactions.functionCall("addMessage", { text: "test" }, new bn_js_1.default(near_api_js_1.utils.format.parseNearAmount("0.00000000003")), new bn_js_1.default(near_api_js_1.utils.format.parseNearAmount("0"))),
    ];
    return near_api_js_1.transactions.createTransaction("test.testnet", near_api_js_1.utils.PublicKey.from("GF7tLvSzcxX4EtrMFtGvGTb2yUj2DhL8hWzc97BwUkyC"), "guest-book.testnet", 76068360000003, actions, near_api_js_1.utils.serialize.base_decode("DMgHVMag7MAmtEC17Dpvso5DgvqqYcHzrTpTrA86FG7t"));
};
var createLedgerClient = function (params) {
    if (params === void 0) { params = {}; }
    var client = (0, jest_mock_extended_1.mock)(params.client);
    var transport = (0, jest_mock_extended_1.mock)(params.transport);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    data = near_api_js_1.utils.serialize.serialize(near_api_js_1.transactions.SCHEMA, transaction);
                    return [4 /*yield*/, client.connect()];
                case 1:
                    _b.sent();
