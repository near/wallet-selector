...
var neth_js_1 = require("../../utils/neth.js");
var icons_1 = require("../icons");
function setupMetaMaskWallet() {
    return function MetaMaskWallet(_a) {
        var options = _a.options, 
        // provider,
        emitter = _a.emitter, logger = _a.logger, updateState = _a.updateState;
        var wallet;
        /// TODO fix this to redirect to some eth wallet?
        /// TODO check hasAppKey
        ...
        return {
            ...
            description: null,
            iconUrl: icons_1.metaMaskWalletIcon,
            ...
            signIn: function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, neth_js_1.signIn)()];
                            case 1:
            ...
            isSignedIn: function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, (0, neth_js_1.isSignedIn)()];
                    });
                });
            },
            signOut: function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, neth_js_1.signOut)()];
                            case 1:
                                res = _a.sent();
                                if (!res) {
            ...
            getAccount: function () {
                return __awaiter(this, void 0, void 0, function () {
                    var _a, account, accountId;
                    var _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0: return [4 /*yield*/, (0, neth_js_1.getAccount)()];
                            case 1:
                                _a = _c.sent(), account = _a.account, accountId = _a.accountId;
                                if (!account) {
                            ...
                            case 2: return [2 /*return*/, (_b.balance = (_c.sent()).amount,
                                    _b)];
                        }
                    });
                });
            ...
            signAndSendTransaction: function (_a) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                logger.log("MetaMaskWallet:signAndSendTransaction", {
                                    receiverId: receiverId,
                                    actions: actions,
                                });
                                return [4 /*yield*/, (0, neth_js_1.signAndSendTransaction)({ receiverId: receiverId, actions: actions })];
                            case 1:
                                res = _b.sent();
                                if (res.error) {
...
exports.default = setupMetaMaskWallet;
