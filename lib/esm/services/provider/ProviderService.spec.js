...
import { createQueryResponseMock, createFunctionCallResponseMock, createViewAccessKeyResponseMock, createViewAccountResponseMock, } from "./providerServiceMocks";
var defaults = {
    url: "https://rpc.testnet.near.org",
};
var setup = function (url) {
    var provider = mock();
    jest.spyOn(providers, "JsonRpcProvider").mockImplementation(function () { return provider; });
    return {
        provider: provider,
    ...
    it("correctly parses the response", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = setup(defaults.url), service = _a.service, provider = _a.provider;
                    data = createViewAccessKeyResponseMock();
                    provider.query.mockResolvedValue(data);
    ...
    it("correctly parses the response", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = setup(defaults.url), service = _a.service, provider = _a.provider;
                    data = createViewAccountResponseMock();
                    provider.query.mockResolvedValue(data);
