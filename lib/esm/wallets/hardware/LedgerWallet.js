            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 5:
                            err_1 = _b.sent();
                            if (err_1 instanceof TypedError && err_1.type === "AccessKeyDoesNotExist") {
                                return [2 /*return*/, {
                                        publicKey: publicKey,
                                        accessKey: null,
                                    }];
        ...
        return {
            ...
            init: function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        state.authData = storage.getItem(LOCAL_STORAGE_LEDGER_WALLET_AUTH_DATA);
                        return [2 /*return*/];
                    });
                });
            },
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            ...
                            case 2:
                                ...
                                transaction = transactions.createTransaction(accountId, utils.PublicKey.from(publicKey), receiverId, accessKey.nonce + 1, transformActions(actions), utils.serialize.base_decode(block.header.hash));
                                serializedTx = utils.serialize.serialize(transactions.SCHEMA, transaction);
                            ...
                            case 3:
                                signature = _d.sent();
                                signedTx = new transactions.SignedTransaction({
