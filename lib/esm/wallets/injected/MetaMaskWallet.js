...
import { signIn, signOut, isSignedIn, getAccount, signAndSendTransaction, } from "../../utils/neth.js";
import { metaMaskWalletIcon } from "../icons";
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, signAndSendTransaction({ receiverId: receiverId, actions: actions })];
                            case 1:
                                res = _b.sent();
                                if (res.error) {
