            ...
            init: function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                localStorageKeyStore = new keyStores.BrowserLocalStorageKeyStore();
                                return [4 /*yield*/, connect(__assign(__assign({ keyStore: localStorageKeyStore }, getConfig(options.networkId)), { headers: {} }))];
                            case 1:
                                near = _a.sent();
